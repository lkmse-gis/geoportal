...
if ($relief < 1)
   { 	
	...
	$query="SELECT box(st_transform(the_geom,2398)) as box, area(st_transform(the_geom,2398)) as area, st_perimeter(st_transform(the_geom,2398)) as umfang, astext(st_transform(st_centroid(the_geom), 4326)) as geo, astext(st_transform(st_centroid(the_geom), 25833)) as etrs FROM fd_kreis WHERE 1=1"; 
	  ...
	  $boxstring = $r[box];						//Ausdehnung ermitteln
	  $klammern=array("(",")");
	  ...
	  $query="SELECT sum(gesamt) as einwohner, stand FROM fd_bevoelkerung group by stand order by stand DESC LIMIT 1;";	  
		$result = $dbqueryp($connectp,$query);
		$r = $fetcharrayp($result);
	  ...
	  $query="SELECT sum(gesamt) as einwohner, stand FROM fd_bevoelkerung group by stand order by stand;";	  
		$result = $dbqueryp($connectp,$query);
		$z=0;
...
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    function load() {
        map = new OpenLayers.Map({
			...
			scales: [750000,650000,600000,550000,500000,450000,350000,250000,150000,75000,70000,65000,60000,55000,50000,45000,40000,35000,30000,25000,20000,15000,10000,5000,2500,1000,500],
			maxResolution: "auto",
        ...
        map.addLayers([osm_citymap,topomv,dop,schablone,amt_outline,kreisgrenze,amtssitz,kreissitz]);	
...
<style type="text/css">
 #map {width:630px;height: 590px;border: 1px solid white;}
</style>
<style type="text/css">
										...
										<table width=350 border=0>
											...
											<tr bgcolor=<? echo $element_farbe ?>>
												...
												<td>
													<?php for($v=0;$v<$z;$v++)
													{ 
														echo $bubu[$v][einwohner]," (",$bubu[$v][stand],")<br>";
													}
													?>
												</td>
											</tr>
						...
						<tr>
							<td align=center valign=top>
								...
								<div id="eintraege2">
										<table width=350 border=0>
											<tr bgcolor=<? echo $element_farbe ?>>
												<td height=25>&nbsp;&nbsp;Fläche Landkreis:&nbsp;&nbsp;</td>
											...
											<tr>
												<td height=25>&nbsp;&nbsp;Grenzlänge des Landkreises:&nbsp;&nbsp;</td>
...
<div id="container">
					...
					<table border=0 align=center>
								...
								<table border=0>
									<tr>
										<td colspan=2 height=50 bgcolor=<? echo $header_farbe ?>>
											<font size="2" color=white><b>&nbsp;&nbsp;Regionalstandort Waren (Müritz) in Zahlen und<br>&nbsp;&nbsp;Fakten</b></font>
										</td>
									</tr>
									<tr bgcolor=<? echo $element_farbe ?>>
										<td height=25>
						...
						<tr>
							<td align=center>
								<table border=0>
										<tr>
											<td colspan=2 height=30 width=320 bgcolor=<? echo $header_farbe ?>><font size="2" color=white><b>&nbsp;&nbsp;Geodätische Daten (gerechnet und gerundet)</b></font></td>
										</tr>
										<tr bgcolor=<? echo $element_farbe ?>>
											<td height=25>&nbsp;&nbsp;Fläche Landkreis:&nbsp;&nbsp;</td>
											<td><b>&nbsp;&nbsp;1718 km²&nbsp;&nbsp;</b></td>
  ...
  <div id="extra">
	<table border='0' width='100%'>
		<tr>
			<td><b>
				<small><a href=\"javascript:ajaxpage('hinweise_ie.php', 'content')\">Hinweise für Internet Explorer-Nutzer</a>
			</td>
			<td align='right'><b>
