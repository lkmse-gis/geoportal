...
if ($lsg_id < 1)
    { 
		...
		<?
             $lsg_karte= new karte;
             echo $lsg_karte->zeigeKarteBox($box_mse_gesamt,'690','490','orka','1','0','0','0','0',$beschriftung_karte,$layer);			 
            ?>
...
if ($lsg_id > 0)
   {   
	  ...
	  ?>
		...
		<?
             $lsg_karte= new karte;
             echo $lsg_karte->zeigeKarteBox($boxstring,'700','320','orka','1','0','0','0','0',$beschriftung_karte,$layer);			 
        ?> 
		<script type="text/javascript" language="JavaScript1.2" src="um_menu.js"></script>
