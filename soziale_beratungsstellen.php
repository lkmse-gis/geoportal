...
//globale Varibalen
$layername_mapfile="soziale_beratungsstellen";
$titel="Soziale Beratungsstellen";
$titel_legende="Soziale Beratungsstellen";
$scriptname="soziale_beratungsstellen.php";
$tabelle="geoportal_apotheken";
$schema="geoportal";
$get_themenname="Sozialwesen";
$layerid="90870";
							...
							<td>
								...
								<table border=0 width="100%" valign=top>
									...
									<tr>
													...
													<td align=center height=30><b>Inhaber:</b></td>
												...
												<?php for($v=0;$v<$z;$v++)
													{ 
														...
														if(strlen($bildname) < 1 OR $apotheke[$v][oeffentlich] == 'nein')
															{
																echo "<td></td>";	
															} 
														else 
														...
														echo "
														<td align='center' height='30'><a href=\"$scriptname?$get_themenname=",$apotheke[$v][gid],"\">",$apotheke[$v][bezeichnung],"</a></td>",
														"<td align='center'>",$apotheke[$v][ih],"</td>",
														"<td align='center'>",$anschrift,"</td>",
														"<td align='center'>",$apotheke[$v][email],"</td>",
														"<td align='center'>",$apotheke[$v][tel],"</td></tr>";
													}
												?>																																				
											</table>
										</td>
...
<?  }
 ...
 if ($themen_id > 0)
   {   
	  ...
	  $query="SELECT astext(wkb_geometry) as utm, astext(st_transform(wkb_geometry,2398)) as gk4283,astext(st_transform(wkb_geometry, 4326)) as geo,astext(st_transform(wkb_geometry, 31468)) as rd83, gid, geoportal_anschrift, bezeichnung, ih, tel, fax, internet, email, bild, oeffentlich, oeffnungszeiten FROM $schema.$tabelle WHERE gid='$themen_id'";
