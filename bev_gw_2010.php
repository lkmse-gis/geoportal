...
//globale Varibalen
$titel="Bevoelkerungsgewichtung_2010";
$titel2="Bevoelkerungsgewichtung_2010";
$datei="bev_gw_2010.php";
...
if ($gemeinde_id < 1)
    { 
		$query="SELECT COUNT(*) AS anzahl FROM $tabelle where stichtag='31.12.2010'";	  
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungsgewichtung*</h3>Stichtag: 31.12.2010<br><br>
								...
								<tr>
									<td align="center" height=40 colspan=2>
										...
										<select name="<? echo $kuerzel;?>" onchange="document.<? echo $kuerzel;?>.submit();" style="width: 200px;">
											<?php
												$query="SELECT gemeinde, gem_schl FROM $tabelle where stichtag='31.12.2010' ORDER BY gemeinde";
												$result = $dbqueryp($connectp,$query);
...
if ($gemeinde_id > 0)
   {   
	  $query="SELECT name, amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE b.stichtag='31.12.2010' and ST_INTERSECTS(a.the_geom,st_buffer(b.the_geom,-10)) AND b.gem_schl='$gemeinde_id' ORDER by b.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $amtname=$r[0];
	  $amt=$r[1];
					...
					<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
							...
							<td valign=top>											
								<table border=0 cellspacing=0 valign=top>
									<tr height="35">
										<td colspan=3  width="620" bgcolor=<? echo $header_farbe ;?>>&nbsp;&nbsp;<? echo $font_farbe ;?><font size="+1"><a name="anker"><? echo $r[gemeinde]." - 31.12.2010" ;?></a><? echo $font_farbe_end ;?></td>													
									</tr>
									<tr height="30">
