...
//globale Varibalen
$titel="Bevoelkerungsdichte_2011";
$titel2="Bevoelkerungsdichte_2011";
$datei="bev_dichte_2011.php";
$tabelle="population.g_bevoelkerung";
$kuerzel="bevdichte_2011";
$layerid="85120";
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungsdichte*</h3>Stichtag: 31.12.2011<br><br>
...
if ($gemeinde_id > 0)
   {   
	  $query="SELECT name, amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE b.stichtag='31.12.2011' AND ST_INTERSECTS(a.the_geom,st_buffer(b.the_geom,-10)) AND b.gem_schl='$gemeinde_id' ORDER by b.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $amtname=$r[0];
	  $amt=$r[1];
