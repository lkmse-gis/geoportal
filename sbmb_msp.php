...
$titel2="Stra&szlig;enmeistereibereich";
$datei="sbmb_msp.php";
$tabelle="fd_strassenmeisterei";
$kuerzel="sbmb";
$layerid="70200";
			...
			<body onload="init();load();">
				<div id="container">
					...
					<div id="wrapper">
					    ...
					    *) <a href="metadaten/metadaten.php?Layer_ID=<? echo $layerid;?>" target="_blank" onclick="return meta_popup(this.href)">Info zum Thema<br>Stra&szlig;enmeistereibereiche</a>
						         </td>
					            </tr>
                                ...
                                <tr>									
										<td valign=bottom align=right>
											...
											<table border="1" rules="none" width="100%" valign=bottom align=right>					
												...
												<tr>
													<td align=right><small>Demmin: </td>
													<td align=right><img src="images/sbmb_dm.gif" width=30></td>
													<td align=right><small>Eggesin: </td>
													<td align=right><img src="images/sbmb_egg.gif" width=30></td>
												</tr>
												<tr>
													<td align=right><small>Neubrandenburg: </td>
													<td align=right><img src="images/sbmb_nb.gif" width=30></td>
													<td align=right><small>Neustrelitz: </td>
													<td align=right><img src="images/sbmb_nz.gif" width=30></td>
												</tr>
												<tr>
													<td align=right><small>Pasewalk: </td>
													<td align=right><img src="images/sbmb_pas.gif" width=30></td>
													<td align=right><small>Stavenhagen: </td>
													<td align=right><img src="images/sbmb_sta.gif" width=30></td>
												</tr>
												<tr>
													<td align=right><small>Waren: </td>
													<td align=right><img src="images/sbmb_wrn.gif" width=30></td>
...
if ($sbmb_id > 0)
   {   
	  //Ämter ermitteln
	  $query="SELECT a.name, a.amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE ST_INTERSECTS(b.the_geom,a.the_geom) AND b.gid='$sbmb_id' ORDER by a.name";
	  $result = $dbqueryp($connectp,$query);
	  $i=0;
	  while($r = $fetcharrayp($result))
	    {
	  ...
	  //Gemeinden ermitteln
	  $query="SELECT a.gem_schl, a.gemeinde FROM gemeinden as a, $tabelle as b WHERE ST_INTERSECTS(b.the_geom,a.the_geom) AND b.gid='$sbmb_id' ORDER by a.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $k=0;
	  while($r = $fetcharrayp($result))
	    {
	  ...
	  $query="SELECT a.gid, a.name, a.plz, a.ort, a.strasse FROM fd_sba_bereich as a, $tabelle as b WHERE ST_INTERSECTS(ST_BUFFER(b.the_geom,-5),a.the_geom) AND b.gid='$sbmb_id' ORDER by a.name";
	  $result = $dbqueryp($connectp,$query);
	  $s=0;
	  while($r = $fetcharrayp($result))
	    {
	  ...
	  $query="SELECT a.gid, a.name, a.plz, a.ort, a.strasse FROM fd_smv as a, $tabelle as b WHERE ST_INTERSECTS(b.the_geom,a.the_geom) AND b.gid='$sbmb_id' ORDER by a.name";
	  $result = $dbqueryp($connectp,$query);
	  $t=0;
	  while($r = $fetcharrayp($result))
	    {
	  ...
	  if ($rechts_range > $hoch_range) $range=$rechts_range;
		...
		<script type="text/javascript" language="Javascript">
			...
			function load() {
				...
				var <? echo $kuerzel;?>_markierung = new OpenLayers.Layer.WMS.Untiled("Markierung <? echo $r[name]; ?>",
								 <? echo $sbmbmap_url; ?>,
				...
				map.addLayers([topomv,dop,<? echo $kuerzel;?>,<? echo $kuerzel;?>_markierung,kreisgrenze]);
							...
							<td valign=top>
								<table border=0>
									...
									<tr>
										...
										<td align=right>
											<a href="<? echo $datei;?>?<? echo $kuerzel;?>=<? echo $sbmb_id; ?>"><img src="images/reload.png" title="Kartenausschnitt neu laden"></a>
										</td>
									</tr>
								</table>
							</td>
							...
							<td valign=top>											
								<table border=0 valign=top>
									...
									<tr height="30">
										...
										<td bgcolor=<? echo $element_farbe ?>><b><? echo "<a href=\"sbm_msp.php?sbm=",$sbmbid,"\">",$sbmbname,"</a></b>" ;?></td>													
									</tr>
									<tr height="30">
