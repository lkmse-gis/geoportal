										...
										while($r = $fetcharrayp($result))
											{
												...
												echo "<a href='$themendatei?speicher=$serialized&ebene=2&gemeinde=$r[ortslage]&ortslage_id=$r[ort_id]'";if ($r[ort_typ] == 'Gemeinde') echo "class=bld ";echo "><h5>$r[ortslage]</h5></a>";
											}
