...
<section>
 ...
 <div id="sonstwas">
					...
					<link rel="stylesheet" href="module/ol3-layerswitcher-master/src/ol3-layerswitcher.css" />		
							<div id="map" class="map" style="height:500px;border-bottom: 1px solid lightgrey"></div>
					...
					<script >
						...
						var wmsDOP = new ol.source.ImageWMS({
						...
						var base_group = new ol.layer.Group({ 
                 			title: 'Basiskarten',
							layers: [osm,orka_mv,dop]
						});
							
						var overlay_group = new ol.layer.Group({ 
                 			title: 'Fachdaten',
							layers: [Aemter,schablone,kreisgrenze]
						});
						...
						var myView = new ol.View({
							...
							center: [370900, 5939000],//[370900, 5939000],
							resolution: 205,//205,
							zoom: 0							
						});
...
<div class="container" >
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block" >
               <a href="https://geoport-lk-mse.de/kvwmap" target="blank" style="background-color:#006085;"><div id="ssb-bg"></div>
                 <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" class="material-icons" aria-hidden="true">vpn_lock</i></div>
                 <h2 class="ssb-title">kvwmap</h2>  
               </a>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block">
               <a href="https://geoport-lk-mse.de/kvwmap/index.php?gast=50" target="blank" style="background-color:#75b726;"><div id="ssb-bg"></div>
                 <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" class="material-icons" aria-hidden="true">public</i></div>
                 <h2 class="ssb-title">Bürgerportal</h2>  
               </a>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block">
               <a href="http://geoport-lk-mse.de/mp/portale/start" target="blank" ><div id="ssb-bg"></div>
                 <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" aria-hidden="true" class="material-icons">map</i></div>
                 <h2 class="ssb-title">Kartenportal</h2>  
               </a>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block">
               <a href="http://geoport-lk-mse.de/geoshop/" target="blank"  style="background-color:#006085;"><div id="ssb-bg"></div>
			   <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" class="material-icons" aria-hidden="true">shopping_cart</i></div>
                 <h2 class="ssb-title">Geoshop</h2>  
               </a>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block">
               <a href="dienste.php" style="background-color:#75b726;"><div id="ssb-bg"></div>
                 <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" class="material-icons" aria-hidden="true">layers</i></div>
                 <h2 class="ssb-title">Dienste</h2>  
               </a>
            </div>
          </div>	
          ...
          <div class="col-sm-4 col-md-4 col-lg-2">
            <div class="square-service-block" >
               <a href="http://geoport-lk-mse.de/geowiki/" target="blank" ><div id="ssb-bg"></div>
                 <div class="ssb-icon"><i style="color:#fff;opacity:1;font-size:1.5em;" class="material-icons" aria-hidden="true">language</i></div>
                 <h2 class="ssb-title">GeoWiki</h2>  
               </a>
            </div>
          </div>
...
<div class="container">
	...
	<h1  style="color:#fff;"> <b>LK Mecklenburgische Seenplatte</b> | in Zahlen und Fakten </h1><br><br>
