...
$titel="Tankstellen";
$titel_legende="Tankstelle";
$scriptname="tankstellen.php";
...
<?  }
 ...
 if ($themen_id > 0)
   {   
	  ...
	  $query="SELECT astext(wkb_geometry) as utm, astext(st_transform(wkb_geometry,2398)) as gk4283,astext(st_transform(wkb_geometry, 4326)) as geo,astext(st_transform(wkb_geometry, 31468)) as rd83, gid, fa_adressschluessel, bezeichnung, geoportal_anschrift, betreiber, tel, fax, oeffnungszeiten, bild, oeffentlich, copyright, bilddatum, ausstattung FROM $schema.$tabelle WHERE gid='$themen_id'";
