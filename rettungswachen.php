...
//globale Varibalen
$layername_mapfile="Rettungswachen";
$titel="Rettungswachen";
$titel_legende="Rettungswache";
$scriptname="rettungswachen.php";
$tabelle="geoportal_rettungswachen";
$schema="geoportal";
$get_themenname="rettungswache";
$layerid="120030";
$leg_bild="rtw.png";
							...
							<td>
								...
								<table border=0 width="100%" valign=top>
									...
									<tr>
													...
													<td align=center height=30><b>Leiter:</b></td>
												...
												<?php for($v=0;$v<$z;$v++)
													{ 
														$adresse=$rtw[$v][geoportal_anschrift];
														...
														if(strlen($bildname) < 1 OR $rtw[$v][oeffentlich] == 'nein')
															{
																echo "<td></td>";	
															} 
														else 
														...
														echo "
														<td align='center' height='30'><a href=\"$scriptname?$get_themenname=",$rtw[$v][gid],"\">",$rtw[$v][bezeichnung],"</a></td>",
														"<td align='center'>",$rtw[$v][dh],"</td>",
														"<td align='center'>",$anschrift,"</td>",
														"<td align='center'>",$rtw[$v][email],"</td>",
														"<td align='center'>",$rtw[$v][tel],"</td></tr>";
													}
												?>																																				
											</table>
										</td>
