...
//globale Varibalen
$titel="Bevoelkerungsgewichtung_2017";
$titel2="Bevoelkerungsgewichtung_2017";
$datei="bev_gw_2017.php";
...
if ($gemeinde_id < 1)
    { 
		$query="SELECT COUNT(*) AS anzahl FROM $tabelle WHERE stichtag='31.12.2017'";	  
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungsgewichtung*</h3>Stichtag: 31.12.2017<br><br>
								...
								<tr>
									<td align="center" height=40 colspan=2>
										...
										<select name="<? echo $kuerzel;?>" onchange="document.<? echo $kuerzel;?>.submit();" style="width: 200px;">
											<?php
												$query="SELECT gemeinde, gem_schl FROM $tabelle WHERE stichtag='31.12.2017' ORDER BY gemeinde";
												$result = $dbqueryp($connectp,$query);
...
if ($gemeinde_id > 0)
   {   
	  $query="SELECT name, amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE b.stichtag='31.12.2017' AND ST_INTERSECTS(a.the_geom,st_buffer(b.the_geom,-10)) AND b.gem_schl='$gemeinde_id' ORDER by b.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $amtname=$r[0];
	  $amt=$r[1];
					...
					<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
							...
							<td valign=top>											
								<table border=0 cellspacing=0 valign=top>
									<tr height="35">
										<td colspan=3  width="620" bgcolor=<? echo $header_farbe ;?>>&nbsp;&nbsp;<? echo $font_farbe ;?><font size="+1"><a name="anker"><? echo $r[gemeinde]." - 31.12.2017" ;?></a><? echo $font_farbe_end ;?></td>													
									</tr>
									<tr height="30">
									...
									<tr height="30">
										...
										<td colspan=2>
											...
											<b><? echo "<a href=\"bev_gw_2015.php?bev_gw_2015=",$r[gem_schl],"\">2015</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2014.php?bev_gw_2014=",$r[gem_schl],"\">2014</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2013.php?bev_gw_2013=",$r[gem_schl],"\">2013</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2012.php?bev_gw_2012=",$r[gem_schl],"\">2012</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2011.php?bev_gw_2011=",$r[gem_schl],"\">2011</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2010.php?bev_gw_2010=",$r[gem_schl],"\">2010</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2009.php?bev_gw_2009=",$r[gem_schl],"\">2009</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_1995.php?bev_gw_1995=",$r[gem_schl],"\">1995</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_1990.php?bev_gw_1990=",$r[gem_schl],"\">1990</a>";?></b>
										</td>							
									</tr>
									<tr height="30">
