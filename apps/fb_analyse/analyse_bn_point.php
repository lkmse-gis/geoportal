...
$count = 0;
$query="SELECT gid,bezeichnung,st_buffer(the_geom,radius) as search_geom,area(st_buffer(the_geom,radius)) as area_search_geom,radius,x(the_geom) as rechts,y(the_geom) as hoch FROM environment.analysepunkte WHERE gid='$gid'";
...
<table width='800' id='kopf'>
  ...
  <tr>
    <td id='tdkopf1' width='520' valign='top' ><b>$bezeichnung<br>Radius: $radius </td>
...
WHILE ($q = $fetcharrayp($result))
{
	...
	echo "<tr>
		  ...
		  <td colspan=2>davon Grünland (GL):</td>
