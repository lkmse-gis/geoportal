...
<nav class="navbar navbar-default">
   <div class="container-fluid">
     <div class="navbar-header">
       <h3>Funkstandorte <small>im Landkreis Mecklenburgische Seenplatte</small></h3>
     </div>
			...
			<div class="row">
				<div id="sonstwas">
					...
					<script >
						...
						var wmsFunk = new ol.source.ImageWMS({
								
								url: 'https://geoport-lk-mse.de/webservices/wms/funkstandorte_wms',
								params: {	'LAYERS': 'Funkstandorte',
											'VERSION': '1.3.0',
											'FORMAT': 'image/png',
											'TILED': true
										},
						...
						var overlay_group = new ol.layer.Group({ 
                 			title: 'Fachdaten',
							layers: [Aemter,kreisgrenze,schablone,funk]
						});
						...
						map.on('singleclick', function(evt) {
							...
							var url = wmsFunk.getGetFeatureInfoUrl(
								evt.coordinate, viewResolution, projection25833,
								{'INFO_FORMAT': 'text/html'});
							if (url ) {
							document.getElementById('info').innerHTML =
								
										'<br><embed  width="100%" height="280px" src="' + url + '" ></embed>'
										$("#myModal").modal('show');
							}
						});
