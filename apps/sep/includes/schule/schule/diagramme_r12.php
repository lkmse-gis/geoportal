										...
										<li>
											<a href="#" onclick="$('#tB21').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB21">												
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet2_s.php?schul_id=$schul_id&stichtage=$stichtage[1]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet_s.php?schul_id=$schul_id&stichtage=$stichtage[1]\"></td>"; ?>
													</tr>													
												</table>
