<?
		//Schuldaten holen
		$query="SELECT distinct a.bezeichnung, a.schul_id, a.plz, a.ortsteil, a.strasse_haus_nr, a.tel, a.fax, a.mail as email, a.schulleiter, a.schultraeger FROM $schema.$tabelle as a where a.stichtag = '2012-09-12' AND a.schul_id = '$schul_id'";
		$result = $dbqueryp($connectp,$query);
		$r = $fetcharrayp($result);
		$schul_id_2012 = $r[schul_id];
		$bezeichnung_2012 = $r[bezeichnung];
		$schulname_2012 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2012 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2012 = $r[schulleiter];
		$tel_2012 = $r[tel];
		$fax_2012 = $r[fax];
		$mail_2012 = $r[email];
