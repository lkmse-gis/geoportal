<?
		//Schuldaten holen
		$query="SELECT distinct a.bezeichnung, a.schul_id, a.plz, a.ortsteil, a.strasse_haus_nr, a.tel, a.fax, a.mail as email, a.schulleiter, a.schultraeger FROM $schema.$tabelle as a where a.stichtag = '2017-09-29' AND a.schul_id = '$schul_id'";
		$result = $dbqueryp($connectp,$query);
		$r = $fetcharrayp($result);
		$schul_id_2019 = $r[schul_id];
		$bezeichnung_2019 = $r[bezeichnung];
		$schulname_2019 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2019 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2019 = $r[schulleiter];
		$tel_2019 = $r[tel];
		$fax_2019 = $r[fax];
		$mail_2019 = $r[email];
