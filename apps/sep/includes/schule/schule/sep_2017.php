<?
		...
		$schul_id_2017 = $r[schul_id];
		$bezeichnung_2017 = $r[bezeichnung];
		$schulname_2017 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2017 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2017 = $r[schulleiter];
		$tel_2017 = $r[tel];
		$fax_2017 = $r[fax];
		$mail_2017 = $r[email];
