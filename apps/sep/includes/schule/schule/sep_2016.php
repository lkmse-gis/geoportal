<?
		//Schuldaten holen
		$query="SELECT distinct a.bezeichnung, a.schul_id, a.plz, a.ortsteil, a.strasse_haus_nr, a.tel, a.fax, a.mail as email, a.schulleiter, a.schultraeger FROM $schema.$tabelle as a where a.stichtag = '2016-09-30' AND a.schul_id = '$schul_id'";
		$result = $dbqueryp($connectp,$query);
		$r = $fetcharrayp($result);
		$schul_id_2016 = $r[schul_id];
		$bezeichnung_2016 = $r[bezeichnung];
		$schulname_2016 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2016 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2016 = $r[schulleiter];
		$tel_2016 = $r[tel];
		$fax_2016 = $r[fax];
		$mail_2016 = $r[email];
