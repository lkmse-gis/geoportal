<?
		//Schuldaten holen
		$query="SELECT distinct a.bezeichnung, a.schul_id, a.plz, a.ortsteil, a.strasse_haus_nr, a.tel, a.fax, a.mail as email, a.schulleiter, a.schultraeger FROM $schema.$tabelle as a where a.stichtag = '2014-09-23' AND a.schul_id = '$schul_id'";
		$result = $dbqueryp($connectp,$query);
		$r = $fetcharrayp($result);
		$schul_id_2014 = $r[schul_id];
		$bezeichnung_2014 = $r[bezeichnung];
		$schulname_2014 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2014 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2014 = $r[schulleiter];
		$tel_2014 = $r[tel];
		$fax_2014 = $r[fax];
		$mail_2014 = $r[email];
