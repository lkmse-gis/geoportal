										...
										<li>
											<a href="#" onclick="$('#tA91').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<table class="bordered" id="tA91">
														<thead>	
															<tr>
																<td style="text-align:center;" colspan=22>2019 Schuldaten</td>														
															</tr>
														</thead>
														<tbody>
															<tr>
																<td>Bezeichnung:</td>
																<td colspan=21><?php echo $schulname_2019; ?></td>
															</tr>
															<tr>
																<td>Schul-ID:</td>
															...
															<tr>
																...
																<td colspan=21><?php echo $anschrift_2019; ?></td>
															</tr>
															<tr>
																<td>Schulleiter:</td>
																<td colspan=21><?php echo $schulleiter_2019; ?></td>
															</tr>													
															<?
																if ($schul_id_2019 = '75530240')
																	{
																		$teil=explode(';',$tel_2019);
																		echo "<tr>
																				...
																				<td>Telefon:</td>
																				<td colspan=21>$tel_2019</td>
																			</tr>";
															?>									
															<tr>
																<td>Fax:</td>
																<td colspan=21><?php echo $fax_2019; ?></td>
															</tr>
															<tr>
																<td>E-Mail:</td>
																<td colspan=21><?php echo $mail_2019; ?></td>
															</tr>
														</tbody>	
													</table>