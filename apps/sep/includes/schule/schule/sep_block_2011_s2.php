<div class="btn-group">				 
									...
									<ul class="dropdown-menu">					
										<li>
											<a href="#" onclick="$('#tA12').tableExport({type:'excel', worksheetName: 'Schulentwicklungsplanung', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});"><img src='../../export_libs/icons/xls.png' alt="XLSX" style="width:24px">  ... als Excel</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA12').tableExport({type:'doc'});"><img src='../../export_libs/icons/word.png' alt="WORD" style="width:24px">  ... als Word</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA12').tableExport({type:'csv'});"><img src='../../export_libs/icons/csv.png' alt="CSV" style="width:24px">  ... als CSV</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA12').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
										</li>
									</ul>
								</div>
								
													<table class="bordered" id="tA12">
													<thead>
													<tr>
														<td style="text-align:center;" colspan=23>2011 Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenenanzahl</td>														
													</tr>
													<tr>
														<td></td>
													...
													<tr>
														...
														for($c_2011=0;$c_2011<$d_2011;$c_2011++)
															{ 
																...
																"<td>",$schuelerjgst_2011[$c_2011][21],"</td>",	
																"<td>",$schuelerjgst_2011[$c_2011][22],"</td></tr>";
															};
														?>
													<tr>
														<?php 
