									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA34').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2013 Schülerzahlen gruppiert nach Gemeinden</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($a_2013=0;$a_2013<$b_2013;$a_2013++)
															{ 
																echo "<td>",$schuelergkz_2013[$a_2013][1],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][2],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][3],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][4],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][5],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][6],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][7],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][8],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][9],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][10],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][11],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][12],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][13],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][14],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][15],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][16],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][17],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][18],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][19],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][20],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][21],"</td>",
																"<td>",$schuelergkz_2013[$a_2013][22],"</td></tr>";
															};
														?>
													<tr>
														<?php 
