									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA63').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2017 Schülerzahlen gruppiert nach Klassenstufen</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($v_2017=0;$v_2017<$x_2017;$v_2017++)
															{ 
																echo "<td>",$schuelerklassen_2017[$v_2017][0],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][1],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][2],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][3],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][4],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][5],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][6],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][7],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][8],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][9],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][10],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][11],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][12],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][13],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][14],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][15],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][16],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][17],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][18],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][19],"</td>",
																"<td>",$schuelerklassen_2017[$v_2017][20],"</td>",	
																"<td>",$schuelerklassen_2017[$v_2017][21],"</td></tr>";
															};
														?>
													<tr>
														<?php 
