									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA94').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2019 Schülerzahlen gruppiert nach Gemeinden</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($a_2019=0;$a_2019<$b_2019;$a_2019++)
															{ 
																echo "<td>",$schuelergkz_2019[$a_2019][1],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][2],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][3],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][4],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][5],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][6],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][7],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][8],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][9],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][10],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][11],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][12],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][13],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][14],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][15],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][16],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][17],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][18],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][19],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][20],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][21],"</td>",
																"<td>",$schuelergkz_2019[$a_2019][22],"</td></tr>";
															};
														?>
													<tr>
														<?php 
