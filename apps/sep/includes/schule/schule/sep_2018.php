<?
		...
		$schul_id_2018 = $r[schul_id];
		$bezeichnung_2018 = $r[bezeichnung];
		$schulname_2018 = $r[bezeichnung]."&nbsp;".$r[ortsteil];
		$anschrift_2018 = $r[strasse_haus_nr]."<br>".$r[plz]."&nbsp;".$r[ortsteil];
		$schulleiter_2018 = $r[schulleiter];
		$tel_2018 = $r[tel];
		$fax_2018 = $r[fax];
		$mail_2018 = $r[email];
