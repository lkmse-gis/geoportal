	...
	<tr>
		<?
			for($a=0;$a<$i;$a++){ 
					...
					echo "<td><img  class=\"img-thumbnail\" align='center' width='750' height='750' src=\"http://www.geoport-lk-mse.de/cgi-bin/mapserv?map=/var/www/wms/protected/seb.map&REQUEST=GetMap&VERSION=1.1.1&SERVICE=WMS&LAYERS=ORKA,$layer&BBOX=$abox&SRS=EPSG:25833&FORMAT=image/png&WIDTH=750&HEIGHT=750\"></td>";
