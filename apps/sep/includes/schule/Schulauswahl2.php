									...
									<select class="form-control select select-primary" data-toggle="select" name="schul_id" onchange="document.schul_id.submit();">
										...
										<?php
											...
											while($e = $fetcharrayp($result))
												{
													echo "<option";if ($schul_id == $e[schul_id]) echo " selected"; echo " value=\"$e[schul_id]\">".$e[ortsteil]." ".$e[bezeichnung]."</option>\n";
												}
										?>
									</select>
								</form>
							...
							<nav class="navbar navbar-default" role="navigation">
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav">
										...
										<!--Menü-Button zurück-->
										<a class="navbar-brand" href="#" onClick="window.location='Schulauswahl.php'"><span class="glyphicon glyphicon-arrow-left"></span>  zurück</a>
											...
											<ul class="dropdown-menu">
												...
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-picture"></span> Karte</a>
													<ul class="dropdown-menu">
														...
														<li><a href="#K92" onclick="javascript:klappe('K92');">Einzugsbereich 2019-09-06</a></li>
													...
													<ul class="dropdown-menu">
														<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
															<ul class="dropdown-menu">
																...
																<li>
																	<a href="#A32" onclick="javascript:klappe('A32');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenenanzahl</a>
																</li>
																<li>
																	<a href="#A33" onclick="javascript:klappe('A33');">Schülerzahlen gruppiert nach Klassenstufen</a>
																</li>
																<li>
																	<a href="#A34" onclick="javascript:klappe('A34');">Schülerzahlen gruppiert nach Gemeinden</a>
																</li>
															</ul>
														</li>
														<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-stats"></span> Diagramme</a>
					...
					<div class="row" charset="utf-8">	
						<div class="col-md-12"><br></br>
							...
							<div style="display: none" id="B91"><h1 class="text-center">Schüleranteil nach Nationalität 2019-09-06</h1>
							   ...
							   <? include("schule/diagramme_r19.php");?><br></br>					   
							</div>
