...
$query="SET client_encoding='LATIN1';SELECT a.stichtag, m.gesamt, p.fluechtlinge_w, s.fluechtlinge_m
...
group by a.stichtag, m.gesamt, p.fluechtlinge_w, s.fluechtlinge_m
order by a.stichtag";
...
#$data=array();
	while($r = $fetcharrayp($result))
	 {
	   $label=$r[stichtag]; 
	   $data[]=array($label,$r[gesamt],$r[fluechtlinge_w],$r[fluechtlinge_m]);
	 }
...
# Main plot title:
$plot->SetTitle('Entwicklung der Fluechtlinge');
