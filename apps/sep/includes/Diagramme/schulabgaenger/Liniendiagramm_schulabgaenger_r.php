...
$query="SET client_encoding='LATIN1';SELECT a.stichtag, 
	coalesce(b.gesamt_b,0)+coalesce(c.gesamt_c,0)+coalesce(d.gesamt_d,0)+coalesce(e.gesamt_e,0)+coalesce(f.gesamt_f,0)+coalesce(i.gesamt_i,0)+coalesce(j.gesamt_j,0) as gesamt,
	coalesce(bw.weiblich_b,0)+coalesce(cw.weiblich_c,0)+coalesce(dw.weiblich_d,0)+coalesce(ew.weiblich_e,0)+coalesce(fw.weiblich_f,0)+coalesce(iw.weiblich_i,0)+coalesce(jw.weiblich_j,0) as weiblich,
	coalesce(bm.maennlich_b,0)+coalesce(cm.maennlich_c,0)+coalesce(dm.maennlich_d,0)+coalesce(em.maennlich_e,0)+coalesce(fm.maennlich_f,0)+coalesce(im.maennlich_i,0)+coalesce(jm.maennlich_j,0) as maennlich	
