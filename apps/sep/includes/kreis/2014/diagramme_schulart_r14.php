										...
										<li>
											<a href="#" onclick="$('#tB42').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB42">													
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_schulart_k.php?stichtage=$stichtage[3]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_bildungsgang_k.php?stichtage=$stichtage[3]\"></td>"; ?>
													</tr>													
												</table>
