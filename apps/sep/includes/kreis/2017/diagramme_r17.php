										...
										<li>
											<a href="#" onclick="$('#tB71').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB71">													
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet2_k.php?stichtage=$stichtage[6]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet_k.php?stichtage=$stichtage[6]\"></td>"; ?>
													</tr>													
												</table>
