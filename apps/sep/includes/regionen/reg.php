...
include("reg/2019/sep_2019_k.php");
include("reg/2018/sep_2018_k.php");
include("reg/2017/sep_2017_k.php");
include("reg/2016/sep_2016_k.php");
include("reg/2015/sep_2015_k.php");
include("reg/2014/sep_2014_k.php");
include("reg/2013/sep_2013_k.php");
include("reg/2012/sep_2012_k.php");
include("reg/2011/sep_2011_k.php");
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="text-center"><br></br>
								<?
									if ($reg_nr == 1){ echo "statistische Auswertung der Region Demmin";}
									elseif ($reg_nr == 2){ echo "statistische Auswertung der Region Mecklenburg-Strelitz";}
									elseif ($reg_nr == 3){ echo "statistische Auswertung der Region Müritz";}
									elseif ($reg_nr == 4){ echo "statistische Auswertung der Region Neubrandenburg";}
								?>
							</h2>							
						</div>
					</div>
							...
							<nav class="navbar navbar-default" role="navigation">
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav">
										...
										<!--Menü-Button zurück-->
										<a class="navbar-brand" href="#" onClick="window.location='Regionen.php'"><span class="glyphicon glyphicon-arrow-left"></span>  zurück</a>
										...
										<li class="dropdown active">
											<a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2019-09-06<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A91" onclick="javascript:klappe('A91');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2018-09-14<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A81" onclick="javascript:klappe('A81');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown active">
											<a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2017-09-29<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A71" onclick="javascript:klappe('A71');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2016-09-30<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A61" onclick="javascript:klappe('A61');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown active">
											<a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2015-09-30<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A51" onclick="javascript:klappe('A51');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown">
											 <a href="#" class="dropdown-toggle" href="#" data-toggle="dropdown">2014-09-23<strong class="caret"></strong></a>
											<ul class="dropdown-menu">
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
													<ul class="dropdown-menu">
														<li>
															<a href="#A41" onclick="javascript:klappe('A41');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
														</li>
														<li>
										...
										<li class="dropdown active">
											...
											<ul class="dropdown-menu">
												...
												<li class="dropdown">
													 <a href="#" class="dropdown-toggle"  href="#" data-toggle="dropdown">2013-09-10<strong class="caret"></strong></a>
													<ul class="dropdown-menu">
														<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
															<ul class="dropdown-menu">
																<li>
																	<a href="#A31" onclick="javascript:klappe('A31');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
																</li>
																<li>
												...
												<li class="dropdown">
													 <a href="#" class="dropdown-toggle"  href="#" data-toggle="dropdown">2012-09-12<strong class="caret"></strong></a>
													<ul class="dropdown-menu">
														<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
															<ul class="dropdown-menu">
																<li>
																	<a href="#A21" onclick="javascript:klappe('A21');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
																</li>
																<li>
												...
												<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown">2011-09-09</a>
													<ul class="dropdown-menu">
														<li class="dropdown dropdown-submenu"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Statistiken</a>
															<ul class="dropdown-menu">
																<li>
																	<a href="#A11" onclick="javascript:klappe('A11');">Schülerzahlen gruppiert nach Jahrgangsstufen der Schüler und Klassenanzahl</a>
																</li>
																<li>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div style="display: none" id="A01">
							   ...
							   <? include("reg/diagramme_k1.php");?><br></br>					   
							</div>
							<div style="display: none" id="A02">
								...
								<? include("reg/diagramme_Aussiedler.php"); ?><br></br>					   
							</div>
							<div style="display: none" id="A03">
								...
								<? include("reg/diagramme_Asylbewerber.php"); ?><br></br>					   
							</div>
							<div style="display: none" id="A04">
								...
								<? include("reg/diagramme_Fluechtlinge.php"); ?><br></br>					   
							</div>
							<div style="display: none" id="A05">
								...
								<? include("reg/diagramme_Migranten.php"); ?><br></br>					   
							</div>
							<div style="display: none" id="A06">
								...
								<? 
									if ($reg_nr == 1){ include("reg/diagramme_schulabgaenger.php");}
									elseif ($reg_nr == 2){ include("reg/diagramme_schulabgaenger.php");}
									elseif ($reg_nr == 3){ include("reg/diagramme_schulabgaenger.php");}
									elseif ($reg_nr == 4){ include("reg/diagramme_schulabgaenger_nb.php");}
								?><br></br>					   
							</div>
							...
							<div style="display: none" id="A91">
								...
								<? include("reg/2019/sep_block_2019_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A92">
								...
								<? include("reg/2019/sep_block_2019_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A93">
								...
								<? include("reg/2019/sep_block_2019_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A94">
								...
								<? include("reg/2019/sep_block_2019_k4.php");?><br></br>						
							</div>
							<!--Diagramme Ausgabe Menü-Button 2019-09-14-->
							<div style="display: none" id="B81"><h1 class="text-center">Schüleranteil nach Nationalität 2019-09-14</h1>
								<button style="float:right; color:black;" type="button" class="btn btn-xs btn-link" onclick="javascript:klappe('B91'); return false">
									<span class="glyphicon glyphicon-remove"></span>
								</button>
							   <? include("reg/2019/diagramme_r19.php");?><br></br>					   
							</div>
							<div style="display: none" id="B92">
							   ...
							   <? include("reg/2019/diagramme_schulart_r19.php");?><br></br>					   
							</div>
							<div style="display: none" id="B93">
							   ...
							   <? include("reg/2019/diagramme_alter_r19.php");?><br></br>					   
							</div>
							<div style="display: none" id="B94">
							   ...
							   <? include("reg/2019/diagramme_alter_w_m_r19.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A81">
								...
								<? include("reg/2018/sep_block_2018_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A82">
								...
								<? include("reg/2018/sep_block_2018_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A83">
								...
								<? include("reg/2018/sep_block_2018_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A84">
								...
								<? include("reg/2018/sep_block_2018_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B81"><h1 class="text-center">Schüleranteil nach Nationalität 2018-09-14</h1>
							   ...
							   <? include("reg/2018/diagramme_r18.php");?><br></br>					   
							</div>
							<div style="display: none" id="B82">
							   ...
							   <? include("reg/2018/diagramme_schulart_r18.php");?><br></br>					   
							</div>
							<div style="display: none" id="B83">
							   ...
							   <? include("reg/2018/diagramme_alter_r18.php");?><br></br>					   
							</div>
							<div style="display: none" id="B84">
							   ...
							   <? include("reg/2018/diagramme_alter_w_m_r18.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A71">
								...
								<? include("reg/2017/sep_block_2017_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A72">
								...
								<? include("reg/2017/sep_block_2017_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A73">
								...
								<? include("reg/2017/sep_block_2017_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A74">
								...
								<? include("reg/2017/sep_block_2017_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B71"><h1 class="text-center">Schüleranteil nach Nationalität 2017-09-29</h1>
							   ...
							   <? include("reg/2017/diagramme_r17.php");?><br></br>					   
							</div>
							<div style="display: none" id="B72">
							   ...
							   <? include("reg/2017/diagramme_schulart_r17.php");?><br></br>					   
							</div>
							<div style="display: none" id="B73">
							   ...
							   <? include("reg/2017/diagramme_alter_r17.php");?><br></br>					   
							</div>
							<div style="display: none" id="B74">
							   ...
							   <? include("reg/2017/diagramme_alter_w_m_r17.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A61">
								...
								<? include("reg/2016/sep_block_2016_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A62">
								...
								<? include("reg/2016/sep_block_2016_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A63">
								...
								<? include("reg/2016/sep_block_2016_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A64">
								...
								<? include("reg/2016/sep_block_2016_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B61"><h1 class="text-center">Schüleranteil nach Nationalität 2016-09-30</h1>
							   ...
							   <? include("reg/2016/diagramme_r16.php");?><br></br>					   
							</div>
							<div style="display: none" id="B62">
							   ...
							   <? include("reg/2016/diagramme_schulart_r16.php");?><br></br>					   
							</div>
							<div style="display: none" id="B63">
							   ...
							   <? include("reg/2016/diagramme_alter_r16.php");?><br></br>					   
							</div>
							<div style="display: none" id="B64">
							   ...
							   <? include("reg/2016/diagramme_alter_w_m_r16.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A51">
								...
								<? include("reg/2015/sep_block_2015_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A52">
								...
								<? include("reg/2015/sep_block_2015_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A53">
								...
								<? include("reg/2015/sep_block_2015_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A54">
								...
								<? include("reg/2015/sep_block_2015_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B51"><h1 class="text-center">Schüleranteil nach Nationalität 2015-09-30</h1>
							   ...
							   <? include("reg/2015/diagramme_r15.php");?><br></br>					   
							</div>
							<div style="display: none" id="B52">
							   ...
							   <? include("reg/2015/diagramme_schulart_r15.php");?><br></br>					   
							</div>
							<div style="display: none" id="B53">
							   ...
							   <? include("reg/2015/diagramme_alter_r15.php");?><br></br>					   
							</div>
							<div style="display: none" id="B54">
							   ...
							   <? include("reg/2015/diagramme_alter_w_m_r15.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A41">
								...
								<? include("reg/2014/sep_block_2014_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A42">
								...
								<? include("reg/2014/sep_block_2014_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A43">
								...
								<? include("reg/2014/sep_block_2014_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A44">
								...
								<? include("reg/2014/sep_block_2014_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B41"><h1 class="text-center">Schüleranteil nach Nationalität 2014-09-23</h1>
							   ...
							   <? include("reg/2014/diagramme_r14.php");?><br></br>					   
							</div>
							<div style="display: none" id="B42">
							   ...
							   <? include("reg/2014/diagramme_schulart_r14.php");?><br></br>					   
							</div>
							<div style="display: none" id="B43">
							   ...
							   <? include("reg/2014/diagramme_alter_r14.php");?><br></br>					   
							</div>
							<div style="display: none" id="B44">
							   ...
							   <? include("reg/2014/diagramme_alter_w_m_r14.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A31">
								...
								<? include("reg/2013/sep_block_2013_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A32">
								...
								<? include("reg/2013/sep_block_2013_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A33">
								...
								<? include("reg/2013/sep_block_2013_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A34">
								...
								<? include("reg/2013/sep_block_2013_k4.php");?><br></br>						
							</div>							
							...
							<div style="display: none" id="B31"><h1 class="text-center">Schüleranteil nach Nationalität 2013-09-10</h1>
							   ...
							   <? include("reg/2013/diagramme_r13.php");?><br></br>					   
							</div>
							<div style="display: none" id="B32">
							   ...
							   <? include("reg/2013/diagramme_schulart_r13.php");?><br></br>					   
							</div>
							<div style="display: none" id="B33">
							   ...
							   <? include("reg/2013/diagramme_alter_r13.php");?><br></br>					   
							</div>
							<div style="display: none" id="B34">
							   ...
							   <? include("reg/2013/diagramme_alter_w_m_r13.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A21">
								...
								<? include("reg/2012/sep_block_2012_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A22">
								...
								<? include("reg/2012/sep_block_2012_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A23">
								...
								<? include("reg/2012/sep_block_2012_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A24">
								...
								<? include("reg/2012/sep_block_2012_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B21"><h1 class="text-center">Schüleranteil nach Nationalität 2012-09-12</h1>
							   ...
							   <? include("reg/2012/diagramme_r12.php");?><br></br>					   
							</div>
							<div style="display: none" id="B22">
							   ...
							   <? include("reg/2012/diagramme_schulart_r12.php");?><br></br>					   
							</div>
							<div style="display: none" id="B23">
							   ...
							   <? include("reg/2012/diagramme_alter_r12.php");?><br></br>					   
							</div>
							<div style="display: none" id="B24">
							   ...
							   <? include("reg/2012/diagramme_alter_w_m_r12.php");?><br></br>					   
							</div>
							...
							<div style="display: none" id="A11">
								...
								<? include("reg/2011/sep_block_2011_k1.php");?><br></br>						
							</div>
							<div style="display: none" id="A12">
								...
								<? include("reg/2011/sep_block_2011_k2.php");?><br></br>						
							</div>
							<div style="display: none" id="A13">
								...
								<? include("reg/2011/sep_block_2011_k3.php");?><br></br>						
							</div>
							<div style="display: none" id="A14">
								...
								<? include("reg/2011/sep_block_2011_k4.php");?><br></br>						
							</div>
							...
							<div style="display: none" id="B11"><h1 class="text-center">Schüleranteil nach Nationalität 2011-09-09</h1>
							   ...
							   <? include("reg/2011/diagramme_r11.php");?><br></br>					   
							</div>
							<div style="display: none" id="B12">
							   ...
							   <? include("reg/2011/diagramme_schulart_r11.php");?><br></br>					   
							</div>
							<div style="display: none" id="B13">
							   ...
							   <? include("reg/2011/diagramme_alter_r11.php");?><br></br>					   
							</div>
							<div style="display: none" id="B14">
							   ...
							   <? include("reg/2011/diagramme_alter_w_m_r11.php");?><br></br>					   
							</div>
						</div>
