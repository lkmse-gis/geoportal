									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA63').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2016 Schülerzahlen gruppiert nach Schulart der Schüler</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($z_2016=0;$z_2016<$c_2016;$z_2016++)
															{ 
																echo "<td>",$schulart_2016_k[$z_2016][0],"</td>",
																"<td>",$schulart_2016_k[$z_2016][1],"</td>",
																"<td>",$schulart_2016_k[$z_2016][2],"</td>",
																"<td>",$schulart_2016_k[$z_2016][3],"</td>",
																"<td>",$schulart_2016_k[$z_2016][4],"</td>",
																"<td>",$schulart_2016_k[$z_2016][5],"</td>",
																"<td>",$schulart_2016_k[$z_2016][6],"</td>",
																"<td>",$schulart_2016_k[$z_2016][7],"</td>",
																"<td>",$schulart_2016_k[$z_2016][8],"</td>",
																"<td>",$schulart_2016_k[$z_2016][9],"</td>",
																"<td>",$schulart_2016_k[$z_2016][10],"</td>",
																"<td>",$schulart_2016_k[$z_2016][11],"</td>",
																"<td>",$schulart_2016_k[$z_2016][12],"</td>",
																"<td>",$schulart_2016_k[$z_2016][13],"</td>",
																"<td>",$schulart_2016_k[$z_2016][14],"</td>",
																"<td>",$schulart_2016_k[$z_2016][15],"</td>",
																"<td>",$schulart_2016_k[$z_2016][16],"</td>",
																"<td>",$schulart_2016_k[$z_2016][17],"</td>",
																"<td>",$schulart_2016_k[$z_2016][18],"</td>",
																"<td>",$schulart_2016_k[$z_2016][19],"</td>",
																"<td>",$schulart_2016_k[$z_2016][20],"</td>",																
																"<td>",$schulart_2016_k[$z_2016][21],"</td></tr>";
															};
														?>
													<tr>
														<?php 
