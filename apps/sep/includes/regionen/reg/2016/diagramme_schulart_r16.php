										...
										<li>
											<a href="#" onclick="$('#tB62').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB62">													
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_schulart_r.php?reg_nr=$reg_nr&stichtage=$stichtage[5]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_bildungsgang_r.php?reg_nr=$reg_nr&stichtage=$stichtage[5]\"></td>"; ?>
													</tr>													
												</table>
