<div class="btn-group">				 
									...
									<ul class="dropdown-menu">					
										<li>
											<a href="#" onclick="$('#tA43').tableExport({type:'excel', worksheetName: 'Schulentwicklungsplanung', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});"><img src='../../export_libs/icons/xls.png' alt="XLSX" style="width:24px">  ... als Excel</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA43').tableExport({type:'doc'});"><img src='../../export_libs/icons/word.png' alt="WORD" style="width:24px">  ... als Word</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA43').tableExport({type:'csv'});"><img src='../../export_libs/icons/csv.png' alt="CSV" style="width:24px">  ... als CSV</a>
										</li>
										<li>
											<a href="#" onclick="$('#tA43').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
										</li>
									</ul>
								</div>
								
													<table class="bordered" id="tA43">
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2014 Schülerzahlen gruppiert nach Schulart der Schüler</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														...
														echo "<td>&sum;</td>
																...
																"<td>",$schuelerzahlen_2014_k[20],"</td>",
																"<td>",$schuelerzahlen_2014_k[21],"</td></tr>";																											
														?>
													</tbody>	
												</table>