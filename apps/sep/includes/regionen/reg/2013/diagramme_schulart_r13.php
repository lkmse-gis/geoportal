										...
										<li>
											<a href="#" onclick="$('#tB32').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB32">													
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_schulart_r.php?reg_nr=$reg_nr&stichtage=$stichtage[2]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Schulart/Kreisdiagramm_bildungsgang_r.php?reg_nr=$reg_nr&stichtage=$stichtage[2]\"></td>"; ?>
													</tr>													
												</table>
