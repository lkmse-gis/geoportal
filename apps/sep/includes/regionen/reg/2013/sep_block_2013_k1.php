<div class="btn-group">				 
									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA31').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
										</li>
									</ul>
								</div>
													...
													<tr>
														...
														for($z_2013=0;$z_2013<$a_2013;$z_2013++)
															{ 
																...
																"<td>",$schuelerjgst_2013_k[$z_2013][21],"</td>",
																"<td>",$schuelerjgst_2013_k[$z_2013][22],"</td></tr>";
															};
														?>
														<tr>
														<?php 
