										...
										<li>
											<a href="#" onclick="$('#tB51').tableExport({type:'png'});"><img src='../../export_libs/icons/png.png' alt="PNG" style="width:24px">  ... als PNG</a>
												...
												<table id="tB51">													
													...
													<tr>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet2_a.php?reg_nr=$reg_nr&stichtage=$stichtage[4]\"></td>"; ?>
														<?php echo "<td><img src=\"../Diagramme/Nationalitaet/Kreisdiagramm_Nationalitaet_a.php?reg_nr=$reg_nr&stichtage=$stichtage[4]\"></td>"; ?>
													</tr>													
												</table>
