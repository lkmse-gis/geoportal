									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA92').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2019 Schülerzahlen gruppiert nach Schularten der Schule</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($z_2019=0;$z_2019<$b_2019;$z_2019++)
															{ 
																echo "<td>",$schularten_2019_k[$z_2019][0],"</td>",
																"<td>",$schularten_2019_k[$z_2019][1],"</td>",
																"<td>",$schularten_2019_k[$z_2019][2],"</td>",
																"<td>",$schularten_2019_k[$z_2019][3],"</td>",
																"<td>",$schularten_2019_k[$z_2019][4],"</td>",
																"<td>",$schularten_2019_k[$z_2019][5],"</td>",
																"<td>",$schularten_2019_k[$z_2019][6],"</td>",
																"<td>",$schularten_2019_k[$z_2019][7],"</td>",
																"<td>",$schularten_2019_k[$z_2019][8],"</td>",
																"<td>",$schularten_2019_k[$z_2019][9],"</td>",
																"<td>",$schularten_2019_k[$z_2019][10],"</td>",
																"<td>",$schularten_2019_k[$z_2019][11],"</td>",
																"<td>",$schularten_2019_k[$z_2019][12],"</td>",
																"<td>",$schularten_2019_k[$z_2019][13],"</td>",
																"<td>",$schularten_2019_k[$z_2019][14],"</td>",
																"<td>",$schularten_2019_k[$z_2019][15],"</td>",
																"<td>",$schularten_2019_k[$z_2019][16],"</td>",
																"<td>",$schularten_2019_k[$z_2019][17],"</td>",
																"<td>",$schularten_2019_k[$z_2019][18],"</td>",
																"<td>",$schularten_2019_k[$z_2019][19],"</td>",
																"<td>",$schularten_2019_k[$z_2019][20],"</td>",																
																"<td>",$schularten_2019_k[$z_2019][21],"</td></tr>";
															};
														?>
													<tr>
														<?php 
														echo "<td>&sum;</td>
																...
																"<td>",$schuelerzahlen_2019_k[20],"</td></tr>";																											
														?>
													</tbody>	
												</table>