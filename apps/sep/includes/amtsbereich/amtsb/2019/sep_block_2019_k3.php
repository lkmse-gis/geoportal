									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA93').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2019 Schülerzahlen gruppiert nach Schulart der Schüler</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($z_2019=0;$z_2019<$c_2019;$z_2019++)
															{ 
																echo "<td>",$schulart_2019_k[$z_2019][0],"</td>",
																"<td>",$schulart_2019_k[$z_2019][1],"</td>",
																"<td>",$schulart_2019_k[$z_2019][2],"</td>",
																"<td>",$schulart_2019_k[$z_2019][3],"</td>",
																"<td>",$schulart_2019_k[$z_2019][4],"</td>",
																"<td>",$schulart_2019_k[$z_2019][5],"</td>",
																"<td>",$schulart_2019_k[$z_2019][6],"</td>",
																"<td>",$schulart_2019_k[$z_2019][7],"</td>",
																"<td>",$schulart_2019_k[$z_2019][8],"</td>",
																"<td>",$schulart_2019_k[$z_2019][9],"</td>",
																"<td>",$schulart_2019_k[$z_2019][10],"</td>",
																"<td>",$schulart_2019_k[$z_2019][11],"</td>",
																"<td>",$schulart_2019_k[$z_2019][12],"</td>",
																"<td>",$schulart_2019_k[$z_2019][13],"</td>",
																"<td>",$schulart_2019_k[$z_2019][14],"</td>",
																"<td>",$schulart_2019_k[$z_2019][15],"</td>",
																"<td>",$schulart_2019_k[$z_2019][16],"</td>",
																"<td>",$schulart_2019_k[$z_2019][17],"</td>",
																"<td>",$schulart_2019_k[$z_2019][18],"</td>",
																"<td>",$schulart_2019_k[$z_2019][19],"</td>",
																"<td>",$schulart_2019_k[$z_2019][20],"</td>",																
																"<td>",$schulart_2019_k[$z_2019][21],"</td></tr>";
															};
														?>
													<tr>
														<?php 
