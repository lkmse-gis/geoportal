									...
									<ul class="dropdown-menu">					
										...
										<li>
											<a href="#" onclick="$('#tA83').tableExport({type:'txt'});"><img src='../../export_libs/icons/txt.png' alt="TXT" style="width:24px">  ... als TXT</a>
													...
													<thead>
													<tr>
														<td style="text-align:center;" colspan=22>2018 Schülerzahlen gruppiert nach Schulart der Schüler</td>														
													</tr>
													<tr>
														<td rowspan=2></td>
													...
													<tr>
														<?php 										
														for($z_2018=0;$z_2018<$c_2018;$z_2018++)
															{ 
																echo "<td>",$schulart_2018_k[$z_2018][0],"</td>",
																"<td>",$schulart_2018_k[$z_2018][1],"</td>",
																"<td>",$schulart_2018_k[$z_2018][2],"</td>",
																"<td>",$schulart_2018_k[$z_2018][3],"</td>",
																"<td>",$schulart_2018_k[$z_2018][4],"</td>",
																"<td>",$schulart_2018_k[$z_2018][5],"</td>",
																"<td>",$schulart_2018_k[$z_2018][6],"</td>",
																"<td>",$schulart_2018_k[$z_2018][7],"</td>",
																"<td>",$schulart_2018_k[$z_2018][8],"</td>",
																"<td>",$schulart_2018_k[$z_2018][9],"</td>",
																"<td>",$schulart_2018_k[$z_2018][10],"</td>",
																"<td>",$schulart_2018_k[$z_2018][11],"</td>",
																"<td>",$schulart_2018_k[$z_2018][12],"</td>",
																"<td>",$schulart_2018_k[$z_2018][13],"</td>",
																"<td>",$schulart_2018_k[$z_2018][14],"</td>",
																"<td>",$schulart_2018_k[$z_2018][15],"</td>",
																"<td>",$schulart_2018_k[$z_2018][16],"</td>",
																"<td>",$schulart_2018_k[$z_2018][17],"</td>",
																"<td>",$schulart_2018_k[$z_2018][18],"</td>",
																"<td>",$schulart_2018_k[$z_2018][19],"</td>",
																"<td>",$schulart_2018_k[$z_2018][20],"</td>",																
																"<td>",$schulart_2018_k[$z_2018][21],"</td></tr>";
															};
														?>
													<tr>
														<?php 
