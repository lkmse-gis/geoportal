...
<table id="kopf">
  <tr>
    <td id="tdkopf1" width="520" valign="top" ><b>Beteiligungsobjekt<br>
			<?php
...
FROM planning.stoerfallanlagen as a,organisation.beteiligen_polygon as b WHERE st_intersects(st_buffer(a.the_geom,a.stoerfall_radius),'$the_geom') AND b.gid = $gid";
