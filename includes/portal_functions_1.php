...
<table border='0' cellpadding='0' cellspacing='0' width=100%><tr><td><img src=\"images/geologo_5.jpg\" width=1200px></td></tr></table>
</div>
...
echo "</td>
<td width=20%><input type='image' src='buttons/lupe.gif' value='Suche' width='19'></form></td>
<td width=20%><a href=\"https://geoport-lk-mse.de/kvwmapmsp\" target=\"_blank\" onclick=\"window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,');return false;\"><img src='buttons/kvwmap_button.gif' border=0></a></td>
<td width=20% align='left'><a href=\"https://geoport-lk-mse.de/kvwmapmsp/index.php?gast=50\" target=\"_blank\" onclick=\"window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,');return false;\"><img src='buttons/buergerportal_button.gif' border=0></a></td>
...
{
  $query="SELECT datum_stand FROM metadaten WHERE layer_id='$thema_id' ";
...
//allgemeine Mapdatei 
$map_url="\"../cgi-bin/mapserv?map=/var/www/wms/mapdata.map&\"";
$map_msp_url="\"/cgi-bin/mapserv?map=/var/www/wms/msp.map&\"";
$borismap_url="\"../cgi-bin/mapserv?map=/var/www/wms/boris_bau_msp.map&\"";			//BORIS Bauland
$boris_agr_map_url="\"../cgi-bin/mapserv?map=/var/www/wms/boris_agr_msp.map&\"";			//BORIS Acker-/Grünland
$kunst_msp_url="\"../cgi-bin/mapserv?map=/var/www/wms/kunst_msp.map&\"";
$offenes_denkmal_msp_url="\"../cgi-bin/mapserv?map=/var/www/wms/offenes_denkmal_msp.map&\"";

//Datei für Feature Info
$featureinfo_url="../cgi-bin/mapserv?map=/var/www/wms/mapdata.map";
$featureinfo_msp_url="../cgi-bin/mapserv?map=/var/www/wms/msp.map";
$featureinfo_boris_bau_msp_url="../cgi-bin/mapserv?map=/var/www/wms/boris_bau_msp.map";
$featureinfo_boris_agr_msp_url="../cgi-bin/mapserv?map=/var/www/wms/boris_agr_msp.map";
$featureinfo_kunst_msp_url="../cgi-bin/mapserv?map=/var/www/wms/kunst_msp.map";
$featureinfo_offenes_denkmal_msp_url="../cgi-bin/mapserv?map=/var/www/wms/offenes_denkmal_msp.map";
$featureinfo_bevoelkerung_msp_url="../cgi-bin/mapserv?map=/var/www/wms/bevoelkerung_msp.map";

//Kataster
$gemeindemap_url="\"../cgi-bin/mapserv?map=/var/www/wms/gemeinden_msp.map&\""; 		//Gemeinden
$plzmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/plz_msp.map&\"";					//Postleitzahlbereiche
$regionmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/regionen_msp.map&\"";			//Regionen
$gemarkungmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/gemarkungen_msp.map&\"";	//Gemarkungen
$amtmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/aemter_msp.map&\"";				//Ämter
...
$bevoelkerung_url="\"/cgi-bin/mapserv?map=/var/www/wms/bevoelkerung_msp.map&\"";					//Bevölkerungsgewichtung

//Umwelt
$spaflmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/spa_fl_msp.map&\"";				//Vogelschutzgebiete
$npamap_url="\"../cgi-bin/mapserv?map=/var/www/wms/npa_msp.map&\"";					//Naturparke
$nlpmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/nlp_msp.map&\"";					//Nationalparke
$nsgmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/nsg_msp.map&\"";					//Naturschutzgebiete
$lsgmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/lsg_msp.map&\"";					//Landschaftsschutzgebiete
$geotopflmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/geotop_fl_msp.map&\"";		//Geotope
$nwgemap_url="\"../cgi-bin/mapserv?map=/var/www/wms/nw_ge_msp.map&\"";				//natürliche Wälder Gebiete
$nwflmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/nw_fl_msp.map&\"";				//natürliche Wälder Einzelflächen
$ffhmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/ffh_fl_msp.map&\"";				//Fauna Flora Habitat

//Verkehr
$sbabmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/sbab_msp.map&\"";				//Straßenbauamtsbereiche
$sbmbmap_url="\"../cgi-bin/mapserv?map=/var/www/wms/sbmb_msp.map&\"";				//Straßenmeistereibereiche

//Gesundheit
$arzt_url="\"../cgi-bin/mapserv?map=/var/www/wms/arzt.map&\"";
$psy_a_url="\"/cgi-bin/mapserv?map=/var/www/wms/psy_a_katalog.map&\"";
