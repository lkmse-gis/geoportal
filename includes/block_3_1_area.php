	...
	echo"
			...
			function load() {
				map = new OpenLayers.Map({
					...
					scales: [750000,700000,650000,600000,550000,500000,450000,400000,350000,250000,200000,150000,100000,75000,70000,65000,60000,55000,50000,45000,40000,30000,20000,15000,10000,5000,4000,3000,2000,1000,500],
