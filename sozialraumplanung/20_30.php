							...
							<table width="100%" border="1" cellpadding="3" cellspacing="0">
								<tr bgcolor="#BDBDBD">
									<td align=center colspan=12 height=50>
										<b>Bevölkerung 20 bis unter 30 pro Jahr</b>							
									</td>							
								</tr>
								<tr>
								...
								<tr>
									<td>männlich %</td>
									<td><? echo round((($m[0]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[1]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[2]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[3]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[4]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[5]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[6]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[7]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[8]/$gesamt_20_29_m)*100),2); ?></td>
									<td><? echo round((($m[9]/$gesamt_20_29_m)*100),2); ?></td>
								</tr>
								<tr>
								...
								<tr>
									<td>weiblich %</td>
									<td><? echo round((($w[0]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[1]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[2]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[3]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[4]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[5]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[6]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[7]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[8]/$gesamt_20_29_w)*100),2); ?></td>
									<td><? echo round((($w[9]/$gesamt_20_29_w)*100),2); ?></td>
								</tr>
								<tr>
