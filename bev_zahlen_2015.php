...
//globale Varibalen
$titel="Bevoelkerungszahlen_2015";
$titel2="Bevoelkerungszahlen_2015";
$datei="bev_zahlen_2015.php";
$tabelle="population.g_bevoelkerung";
$kuerzel="bevzahlen_2015";
$layerid="88880";
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungszahlen*</h3>Stichtag: 31.12.2015<br><br>
								...
								<table border=0 cellspacing=0 valign=top>
									...
									<tr height="30">
										...
										<? if (($r[gesamt]-$r_2015[gesamt]) < 0)
											echo "2014 - ".$r_2015[gesamt]." (&dArr; ",$r[gesamt]-$r_2015[gesamt],")<br>";
											else if (($r[gesamt]-$r_2015[gesamt]) == 0)
												echo "2014 - ".$r_2015[gesamt]." (&hArr; ",$r[gesamt]-$r_2015[gesamt],")<br>";
											else if (($r[gesamt]-$r_2015[gesamt]) > 0)
												echo "2014 - ".$r_2015[gesamt]." (&uArr; ",$r[gesamt]-$r_2015[gesamt],")<br>";
										?>
										<? if (($r[gesamt]-$r_2016[gesamt]) < 0)
											echo "2014 - ".$r_2016[gesamt]." (&dArr; ",$r[gesamt]-$r_2016[gesamt],")<br>";
									...
									<tr height="30">
										...
										<td colspan=2>
											...
											<b><? echo "<a href=\"bev_zahlen_1990.php?bevzahlen_1990=",$r[gem_schl],"\">1990</a>";?></b>
										</td>								
									</tr>
									<tr height="30">
