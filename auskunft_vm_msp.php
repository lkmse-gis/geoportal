...
//globale Varibalen
$titel="Auskunftsstellen Liegenschaftskataster";
$titel2="Auskunftsstelle Liegenschaftskataster";
$datei="auskunft_vm_msp.php";
$tabelle="oebvi";
$schema="organisation";
...
if ($gemeinde_id > 0)
   { 	  
	  $query="SELECT a.oid, a.* FROM $schema.$tabelle as a, gemeinden as b WHERE ST_WITHIN(st_transform(a.the_geom,2398), b.the_geom) AND a.auskunft='ja' AND b.gem_schl='$gemeinde_id' ORDER BY a.vermst_name1";
	  $result = $dbqueryp($connectp,$query);
	  $z=0;
	  while($r = $fetcharrayp($result))
	    {
								...
								<table border=0>
									<tr>
										<td height="40" align="center" valign=top width=270 bgcolor=<? echo $header_farbe; ?>>
											<? echo $font_farbe ;?>Auskunftsstellen in <br> <? echo $gemeindename ?><? echo $font_farbe_end ;?><br><a href="#liste"><? echo $font_farbe ;?>(<? echo $count; ?> Treffer)<? echo $font_farbe_end ;?></a>
										</td>
												...
												<select name="gemeinde" onchange="document.<? echo $kuerzel;?>.submit();">
													<?php
														...
														while($r = $fetcharrayp($result))
															{
																echo "<option";
																if ($gemeinde_id == $r["gem_schl"]) echo " selected"; echo ' value=',$r["gem_schl"],'>',$r["gemeinde"],'</option>\n';
															}
													?>
												</select>
											</form>
									...
									<tr bgcolor=<? echo $header_farbe; ?>>
										...
										<td align=center>
											<a href="<? echo $datei;?>"><? echo $font_farbe ;?>alle Auskunftsstellen<? echo $font_farbe_end ;?></a>
										</td>
...
<?  }
 ...
 if ($themen_id > 0)
   {   
	  ...
	  $query="SELECT astext(st_transform(the_geom,2398)) as koordinaten, astext(the_geom) as utm, astext(st_transform(the_geom, 4326)) as geo,astext(st_transform(the_geom, 31468)) as rd83, vermst_id, plz, ort, strasse, vermst_name1, vermst_name2, hausnr, website, telefon, fax, mail, mo, di, mi, don, fr, oebvi, bild, oeffentlich FROM $schema.$tabelle WHERE vermst_id='$themen_id'";
							...
							<td valign=top>
								<table border=0>
									<tr>
										<td height="40" align="center" valign=center width=270 colspan="2" bgcolor=<? echo $header_farbe; ?>>
											<? echo $font_farbe ;?><? echo $vmname; ?><? echo $font_farbe_end ;?>
										</td>
										<td width=10 rowspan="7"></td>
										<td border=0 valign=top align=left rowspan="6" colspan=3>
											<div style="margin:1px" id="map"></div>
												...
												<select name="gemeinde" onchange="document.<? echo $kuerzel;?>.submit();">
													<?php
														...
														while($e = $fetcharrayp($result))
															{
																echo "<option";if ($gem_id == $e["gem_schl"]) echo " selected"; 
																echo ' value=',$e["gem_schl"],'>',$e["gemeinde"],'</option>\n';
															}
													?>
												</select>
											</form>
									...
									<tr bgcolor=<? echo $header_farbe; ?>>
										...
										<td align=center colspan=2>
											<a href="<? echo $datei;?>"><? echo $font_farbe ;?>zu allen Auskunftsstellen<br><? echo $font_farbe_end ;?></a>
										</td>
									...
									<tr bgcolor=<? echo $header_farbe; ?>>
										...
										<td align=center height="50" colspan=2>
											<a href="<? echo $datei;?>?gemeinde=<? echo $gem_id; ?>"><? echo $font_farbe ;?>zu allen Auskunftsstellen<br><? echo $gemeindename ?><? echo $font_farbe_end ;?></a>
										</td>
								...
								<td valign=top>											
									<table border=0 valign=top>
										...
										<tr>
											...
											<?											
												...
												if(strlen($bildname) < 1 OR $oeffentlich == 'nein')
													...
													{
														echo $bild,$bildname2,"<td valign=top align=right rowspan=10 width=420><a href=$bild target='_blank' onclick='return popup(this.href);'><img height='235' src=$bild height='30'></a></td>";
										...
										<tr>
											<td bgcolor=<? echo $element_farbe ?> align="center" colspan="2">&Ouml;ffnungszeiten</td>
										</tr>
										<tr>
											<td>Montag:</td>
											<td><b><? echo $r["mo"] ;?></b></td>										
										...
										<tr>
											<td bgcolor=<? echo $element_farbe ?>>Dienstag:</td>
											<td bgcolor=<? echo $element_farbe ?>><b><? echo $r["di"] ;?></b></td>
										</tr>
										<tr>
											<td>Mittwoch:</td>
											<td><b><? echo $r["mi"] ;?></b></td>										
										...
										<tr>
											<td bgcolor=<? echo $element_farbe ?>>Donnerstag:</td>
											<td bgcolor=<? echo $element_farbe ?>><b><? echo $r["don"] ;?></b></td>
										</tr>
										<tr>
											<td>Freitag:</td>
											<td><b><? echo $r["fr"] ;?></b></td>										
