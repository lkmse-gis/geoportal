...
//Variablen
$titel="Geotope (Punkte)";
$layer_name="geotope_pkt_2016";
$beschriftung_karte="Geotope";
$tabelle="sg_geotope_pkt_2016";
$schema="environment";
$layerid="32241";
    ...
    { 
		...
		<? include ("includes/meta_popup.php"); ?>
			...
			<?
             ...
             echo $geotopkarte->zeigeKarteBox($box_mse_gesamt,'730','490','orka','1','1','1','0','0',$beschriftung_karte,$layer_name);			 
            ?>
					    ...
					    *) <a href="<? echo $metadatenpfad.$layerid;?>" target="_blank" onclick="return hilfe_popup(this.href)">Info zum Thema <? echo $titel; ?></a>
                                ...
                                <tr>									
										<td valign=bottom align=right>
											<!-- Tabelle für Legende -->
											<?php
											  $geotoplegende=new legende;
											  echo $geotoplegende->geotope_flaechen();
											?>
							...
							<td valign=top>
								<table border=0>
									...
									<tr>
										...
										<td align=right>
											<a href="<? echo $_SERVER["PHP_SELF"];?>?wert=<? echo $objekt_id; ?>"><img src="images/reload.png" title="Kartenausschnitt neu laden"></a>
										</td>
									</tr>
								</table>
							</td>
					...
					<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
							...
							<td valign=top>											
								<table border=0 valign=top>
									...
									<tr>
										<td valign=top>Das Objekt schneidet folgende<br>&Auml;mter des Kreises:</td>
										<td><b>
											<?php 
												for($x=0;$x<$i;$x++)
									...
									<tr>
										<td  bgcolor=<? echo $element_farbe ?> valign=top>Das Objekt schneidet folgende<br>Gemeinden des Kreises:</td>
							...
							<td valign=top align=center width="250">
								<? echo geo_punkt($geometrie,$connectp,$dbqueryp,$fetcharrayp) ?>
							</td>
						</tr>
					</table>				
				</div>
