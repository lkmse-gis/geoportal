...
$layer_legende="Vogelschutzgebiete";
$layer_legende_2="Kreisgrenze_msp";
$layer="Vogelschutzgebiete";
$label_auswahl="Vogelschutzgebiet";
...
if ($spafl_id > 0)
   {   
	  ...
	  $query="SELECT box(st_transform(the_geom,25833)) as etrsbox, st_transform(the_geom,25833) as geom_25833, gid, gebiet_nam, eu_nr, nr, gis_code FROM $schema.$tabelle WHERE gid='$spafl_id'";	  
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $bildname = $r["ziel"];
	  $etrsbox = $r["etrsbox"];
