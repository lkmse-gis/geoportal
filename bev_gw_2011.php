...
//globale Varibalen
$titel="Bevoelkerungsgewichtung_2011";
$titel2="Bevoelkerungsgewichtung_2011";
$datei="bev_gw_2011.php";
...
if ($gemeinde_id < 1)
    { 
		$query="SELECT COUNT(*) AS anzahl FROM $tabelle where stichtag='31.12.2011'";	  
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungsgewichtung*</h3>Stichtag: 31.12.2011<br><br>
								...
								<tr>
									<td align="center" height=40 colspan=2>
										...
										<select name="<? echo $kuerzel;?>" onchange="document.<? echo $kuerzel;?>.submit();" style="width: 200px;">
											<?php
												$query="SELECT gemeinde, gem_schl FROM $tabelle where stichtag='31.12.2011' ORDER BY gemeinde";
												$result = $dbqueryp($connectp,$query);
...
if ($gemeinde_id > 0)
   {   
	  $query="SELECT name, amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE stichtag='31.12.2011' and ST_INTERSECTS(a.the_geom,st_buffer(b.the_geom,-10)) AND b.gem_schl='$gemeinde_id' ORDER by b.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $amtname=$r[0];
	  $amt=$r[1];
					...
					<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
							...
							<td valign=top>											
								<table border=0 cellspacing=0 valign=top>
									<tr height="35">
										<td colspan=3  width="620" bgcolor=<? echo $header_farbe ;?>>&nbsp;&nbsp;<? echo $font_farbe ;?><font size="+1"><a name="anker"><? echo $r[gemeinde]." - 31.12.2011" ;?></a><? echo $font_farbe_end ;?></td>													
									</tr>
									<tr height="30">
									...
									<tr height="30">
										...
										?>
										<? if ((round($r[frau_quote]-$r_1995[frau_quote],2)) < 0)
											echo "1995 - ".round($r_1995[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_1995[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_1995[frau_quote],2)) == 0)
												echo "1995 - ".round($r_1995[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_1995[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_1995[frau_quote],2)) > 0)
												echo "1995 - ".round($r_1995[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_1995[frau_quote],2),"%)<br>";
										?>
									...
									<tr height="30">
										...
										<td colspan=2>
											...
											<b><? echo "<a href=\"bev_gw_1995.php?bevgw_1995=",$r[gem_schl],"\">1995</a>, ";?></b>
