...
$kuerzel="klinik";
$layerid="110030";
$leg_bild="krankenhaus.gif";

$gemeinde_id=$_GET["gemeinde"];
$klinik_id=$_GET["klinik"];
$themen_id=$klinik_id;
								...
								<table border=0>
									<tr>
										<td height="40" align="center" valign=top width=270 bgcolor=<? echo $header_farbe; ?>>
											<? echo $font_farbe ;?>Krankenh&auml;user/ Kliniken in <br> <? echo $gemeindename ?><? echo $font_farbe_end ;?><br><a href="#liste"><? echo $font_farbe ;?>(<? echo $count; ?> Treffer)<? echo $font_farbe_end ;?></a>
										</td>
									...
									<tr bgcolor=<? echo $header_farbe; ?>>										
										<td align=center>
											<a href="<? echo $datei;?>"><? echo $font_farbe ;?>alle Krankenh&auml;user/ Kliniken<? echo $font_farbe_end ;?></a>
										</td>										
									</tr>
							...
							<td>
								...
								<table border=0 width="100%" valign=top>
									...
									<tr>
												    ...
												    <td align=center height=30><b>Faxnummer:</b></td>
													<td align=center height=30><b>Internet:</b></td>													
												</tr>												
												<?php for($v=0;$v<$z;$v++)
													{ 
														$adresse=$klinik[$v]["geoportal_anschrift"];
														$adresse1 = explode(";",$adresse);
														$anschrift = $adresse1[0]."<br>".$adresse1[1]."<br>".$adresse1[2];
														$bildname = $klinik[$v]["bild"];
														...
														if(strlen($bildname) < 1 OR $klinik[$v][oeffentlich] == 'nein')
															{
																echo "<td></td>";	
															} 
														else 
														...
														echo "
														<td align='center' height='30'><a href=\"kh_msp.php?klinik=",$klinik[$v]["gid"],"\">",$klinik[$v]["bezeichnung"],"</a></td>",
														"<td align='center'>",$anschrift,"</td>",
														"<td align='center'>",$klinik[$v]["tel"],"</td>",
														"<td align='center'>",$klinik[$v]["fax"],"</td>",
														"<td align='center'>",$klinik[$v]["internet"],"</td></tr>";
													}
												?>																																				
											</table>
										</td>
...
<?  }
 ...
 if ($themen_id > 0)
   {   
	  ...
	  $query="SELECT astext(st_transform(wkb_geometry,2398)) as koordinaten, astext(wkb_geometry) as utm,astext(st_transform(wkb_geometry, 4326)) as geo,astext(st_transform(wkb_geometry, 31468)) as rd83, gid, bezeichnung, tel, fax, internet, bild, oeffentlich, geoportal_anschrift, typ FROM $schema.$tabelle WHERE gid='$themen_id'";
							...
							<td valign=top>
								<table border=0>
									...
									<tr bgcolor=<? echo $header_farbe; ?>>
										...
										<td align=center colspan=2>
											<a href="<? echo $datei;?>"><? echo $font_farbe ;?>alle Krankenh&auml;user/ Kliniken<br><? echo $font_farbe_end ;?></a>
										</td>
										
									</tr>
									<tr bgcolor=<? echo $header_farbe; ?>>										
										<td align=center height="50" colspan=2>
											<a href="<? echo $datei;?>?gemeinde=<? echo $gem_id; ?>"><? echo $font_farbe ;?>alle Krankenh&auml;user/ Kliniken<br><? echo $gemeindename ?><? echo $font_farbe_end ;?></a>
										</td>										
									</tr>
								...
								<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
									...
									<tr>
										...
										<td bgcolor=<? echo $element_farbe ?>><b><a href="<? echo $r["internet"] ;?>" target=blank><? echo $r["internet"] ;?></a></b></td>																									
									</tr>																		
								</table>
							</td>									
