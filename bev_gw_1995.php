...
//globale Varibalen
$titel="Bevoelkerungsgewichtung_1995";
$titel2="Bevoelkerungsgewichtung_1995";
$datei="bev_gw_1995.php";
...
if ($gemeinde_id < 1)
    { 
		$query="SELECT COUNT(*) AS anzahl FROM $tabelle WHERE stichtag='31.12.1995'";	  
							...
							<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
								<tr>
									...
									<td align="center" valign="top" height=30 colspan=2><br>
										<h3>Bev&ouml;lkerungsgewichtung*</h3>Stichtag: 31.12.1995<br><br>
								...
								<tr>
									<td align="center" height=40 colspan=2>
										...
										<select name="<? echo $kuerzel;?>" onchange="document.<? echo $kuerzel;?>.submit();" style="width: 200px;">
											<?php
												$query="SELECT gemeinde, gem_schl FROM $tabelle WHERE stichtag='31.12.1995' ORDER BY gemeinde";
												$result = $dbqueryp($connectp,$query);
                                ...
                                <tr>									
										<td valign=bottom align=right>
											...
											<table border="1" rules="none" width="100%" valign=bottom align=right>					
												...
												<tr>
													<td align=right><small>M&auml;nneranteil > 50%: </td>
													<td align=right><img src="images/mann_bev_gw.gif" width=30></td>													
													<td align=right><small>Frauenanteil > 50%: </td>
													<td align=right><img src="images/frau_bev_gw.gif" width=30></td>													
												</tr>
												<tr>
													<td align=right><small>Anteile gleich: </td>
													<td align=right><img src="images/ausg_bev_gw.gif" width=30></td>													
...
if ($gemeinde_id > 0)
   {   
	  $query="SELECT name, amts_sf FROM fd_amtsbereiche as a, $tabelle as b WHERE b.stichtag='31.12.1995' AND ST_INTERSECTS(a.the_geom,st_buffer(b.the_geom,-10)) AND b.gem_schl='$gemeinde_id' ORDER by b.gemeinde";
	  $result = $dbqueryp($connectp,$query);
	  $r = $fetcharrayp($result);
	  $amtname=$r[0];
	  $amt=$r[1];
	  
	  $query="SELECT gesamt, km2, maennlich as mann, anteil_m as mann_quote, weiblich as frau, anteil_w as frau_quote FROM population.g_bevoelkerung WHERE stichtag='31.12.1990' and gem_schl='$gemeinde_id'";
	  $result = $dbqueryp($connectp,$query);
	  $r_1990 = $fetcharrayp($result);
							...
							<td valign=top>
								<table border=0>
									...
									<tr>
										...
										<td align=right>
											<a href="<? echo $datei;?>?<? echo $kuerzel;?>=<? echo $bevgw_id; ?>"><img src="images/reload.png" title="Kartenausschnitt neu laden"></a>
										</td>
									</tr>
								</table>
							</td>
					...
					<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
							...
							<td valign=top>											
								<table border=0 cellspacing=0 valign=top>
									<tr height="35">
										<td colspan=3  width="620" bgcolor=<? echo $header_farbe ;?>>&nbsp;&nbsp;<? echo $font_farbe ;?><font size="+1"><a name="anker"><? echo $r[gemeinde]." - 31.12.1995" ;?></a><? echo $font_farbe_end ;?></td>													
									</tr>
									<tr height="30">
									...
									<tr height="30">
										...
										<? if (($r[gesamt]-$r_1990[gesamt]) < 0)
											echo "1990 - ".$r_1990[gesamt]." (&dArr; ",$r[gesamt]-$r_1990[gesamt],")<br>";
											else if (($r[gesamt]-$r_1990[gesamt]) == 0)
												echo "1990 - ".$r_1990[gesamt]." (&hArr; ",$r[gesamt]-$r_1990[gesamt],")<br>";
											else if (($r[gesamt]-$r_1990[gesamt]) > 0)
												echo "1990 - ".$r_1990[gesamt]." (&uArr; ",$r[gesamt]-$r_1990[gesamt],")<br>";
										?>
									...
									<tr height="30">
										...
										<? if (($r[km2]-$r_1990[km2]) < 0)
											echo "1990 - ".$r_1990[km2]." (&dArr; ",$r[km2]-$r_1990[km2],")<br>";
											else if (($r[km2]-$r_1990[km2]) == 0)
												echo "1990 - ".$r_1990[km2]." (&hArr; ",$r[km2]-$r_1990[km2],")<br>";
											else if (($r[km2]-$r_1990[km2]) > 0)
												echo "1990 - ".$r_1990[km2]." (&uArr;",$r[km2]-$r_1990[km2],")<br>";
										?>
										...
										?>
										<? if (($r[km2]-$r_2013[km2]) < 0)
											echo "2013 - ".$r_2013[km2]." (&dArr; ",$r[km2]-$r_2013[km2],")<br>";
											else if (($r[km2]-$r_2013[km2]) == 0)
												echo "2013 - ".$r_2013[km2]." (&hArr; ",$r[km2]-$r_2013[km2],")<br>";
											else if (($r[km2]-$r_2013[km2]) > 0)
												echo "2013 - ".$r_2013[km2]." (&uArr; ",$r[km2]-$r_2013[km2],")<br>";
										?>
										<? if (($r[km2]-$r_2014[km2]) < 0)
											echo "2014 - ".$r_2014[km2]." (&dArr; ",$r[km2]-$r_2014[km2],")<br>";
											else if (($r[km2]-$r_2014[km2]) == 0)
												echo "2014 - ".$r_2014[km2]." (&hArr; ",$r[km2]-$r_2014[km2],")<br>";
											else if (($r[km2]-$r_2014[km2]) > 0)
												echo "2014 - ".$r_2014[km2]." (&uArr; ",$r[km2]-$r_2014[km2],")<br>";
										?>
										<? if (($r[km2]-$r_2015[km2]) < 0)
											echo "2015 - ".$r_2015[km2]." (&dArr; ",$r[km2]-$r_2015[km2],")<br>";
											else if (($r[km2]-$r_2015[km2]) == 0)
												echo "2015 - ".$r_2015[km2]." (&hArr; ",$r[km2]-$r_2015[km2],")<br>";
											else if (($r[km2]-$r_2015[km2]) > 0)
												echo "2015 - ".$r_2015[km2]." (&uArr; ",$r[km2]-$r_2015[km2],")<br>";
										?>
										<? if (($r[km2]-$r_2016[km2]) < 0)
											echo "2016 - ".$r_2016[km2]." (&dArr; ",$r[km2]-$r_2016[km2],")<br>";
											else if (($r[km2]-$r_2016[km2]) == 0)
												echo "2016 - ".$r_2016[km2]." (&hArr; ",$r[km2]-$r_2016[km2],")<br>";
											else if (($r[km2]-$r_2016[km2]) > 0)
												echo "2016 - ".$r_2016[km2]." (&uArr; ",$r[km2]-$r_2016[km2],")<br>";
										?>
										<? if (($r[km2]-$r_2017[km2]) < 0)
											echo "2017 - ".$r_2017[km2]." (&dArr; ",$r[km2]-$r_2017[km2],")<br>";
											else if (($r[km2]-$r_2017[km2]) == 0)
												echo "2017 - ".$r_2017[km2]." (&hArr; ",$r[km2]-$r_2017[km2],")<br>";
											else if (($r[km2]-$r_2017[km2]) > 0)
												echo "2017 - ".$r_2017[km2]." (&uArr; ",$r[km2]-$r_2017[km2],")<br>";
										?>
										</b></td></div>
									</tr>
									<tr height="30">
										...
										<? if (($r[mann]-$r_1990[mann]) < 0)
											echo "1990 - ".$r_1990[mann]." (&dArr; ",$r[mann]-$r_1990[mann],")<br>";
											else if (($r[mann]-$r_1990[mann]) == 0)
												echo "1990 - ".$r_1990[mann]." (&hArr; ",$r[mann]-$r_1990[mann],")<br>";
											else if (($r[mann]-$r_1990[mann]) > 0)
												echo "1990 - ".$r_1990[mann]." (&uArr;",$r[mann]-$r_1990[mann],")<br>";
										?>
									...
									<tr height="30">
										...
										<? if (($r[mann_quote]-$r_1990[mann_quote]) < 0)
											echo "1990 - ".$r_1990[mann_quote]."% (&dArr; ",$r[mann_quote]-$r_1990[mann_quote],"%)<br>";
											else if (($r[mann_quote]-$r_1990[mann_quote]) == 0)
												echo "1990 - ".$r_1990[mann_quote]."% (&hArr; ",$r[mann_quote]-$r_1990[mann_quote],"%)<br>";
											else if (($r[mann_quote]-$r_1990[mann_quote]) > 0)
												echo "1990 - ".$r_1990[mann_quote]."% (&uArr; ",$r[mann_quote]-$r_1990[mann_quote],"%)<br>";
										?>
									...
									<tr height="30">
										...
										<? if (($r[frau]-$r_1990[frau]) < 0)
											echo "1990 - ".$r_1990[frau]." (&dArr; ",$r[frau]-$r_1990[frau],")<br>";
											else if (($r[frau]-$r_1990[frau]) == 0)
												echo "1990 - ".$r_1990[frau]." (&hArr; ",$r[frau]-$r_1990[frau],")<br>";
											else if (($r[frau]-$r_1990[frau]) > 0)
												echo "1990 - ".$r_1990[frau]." (&uArr;",$r[frau]-$r_1990[frau],")<br>";
										?>
									...
									<tr height="30">
										...
										<? if ((round($r[frau_quote]-$r_1990[frau_quote],2)) < 0)
											echo "1990 - ".round($r_1990[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_1990[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_1990[frau_quote],2)) == 0)
												echo "1990 - ".round($r_1990[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_1990[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_1990[frau_quote],2)) > 0)
												echo "1990 - ".round($r_1990[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_1990[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2009[frau_quote],2)) < 0)
											echo "2009 - ".round($r_2009[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2009[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2009[frau_quote],2)) == 0)
												echo "2009 - ".round($r_2009[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2009[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2009[frau_quote],2)) > 0)
												echo "2009 - ".round($r_2009[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2009[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2010[frau_quote],2)) < 0)
											echo "2010 - ".round($r_2010[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2010[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2010[frau_quote],2)) == 0)
												echo "2010 - ".round($r_2010[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2010[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2010[frau_quote],2)) > 0)
												echo "2010 - ".round($r_2010[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2010[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2011[frau_quote],2)) < 0)
											echo "2011 - ".round($r_2011[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2011[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2011[frau_quote],2)) == 0)
												echo "2011 - ".round($r_2011[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2011[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2011[frau_quote],2)) > 0)
												echo "2011 - ".round($r_2011[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2011[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2012[frau_quote],2)) < 0)
											echo "2012 - ".round($r_2012[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2012[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2012[frau_quote],2)) == 0)
												echo "2012 - ".round($r_2012[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2012[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2012[frau_quote],2)) > 0)
												echo "2012 - ".round($r_2012[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2012[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2013[frau_quote],2)) < 0)
											echo "2013 - ".round($r_2013[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2013[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2013[frau_quote],2)) == 0)
												echo "2013 - ".round($r_2013[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2013[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2013[frau_quote],2)) > 0)
												echo "2013 - ".round($r_2013[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2013[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2014[frau_quote],2)) < 0)
											echo "2014 - ".round($r_2014[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2014[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2014[frau_quote],2)) == 0)
												echo "2014 - ".round($r_2014[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2014[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2014[frau_quote],2)) > 0)
												echo "2014 - ".round($r_2014[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2014[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2015[frau_quote],2)) < 0)
											echo "2015 - ".round($r_2015[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2015[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2015[frau_quote],2)) == 0)
												echo "2015 - ".round($r_2015[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2015[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2015[frau_quote],2)) > 0)
												echo "2015 - ".round($r_2015[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2015[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2016[frau_quote],2)) < 0)
											echo "2016 - ".round($r_2016[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2016[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2016[frau_quote],2)) == 0)
												echo "2016 - ".round($r_2016[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2016[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2016[frau_quote],2)) > 0)
												echo "2016 - ".round($r_2016[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2016[frau_quote],2),"%)<br>";
										?>
										<? if ((round($r[frau_quote]-$r_2017[frau_quote],2)) < 0)
											echo "2017 - ".round($r_2017[frau_quote],2)."% (&dArr; ",round($r[frau_quote]-$r_2017[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2017[frau_quote],2)) == 0)
												echo "2017 - ".round($r_2017[frau_quote],2)."% (&hArr; ",round($r[frau_quote]-$r_2017[frau_quote],2),"%)<br>";
											else if ((round($r[frau_quote]-$r_2017[frau_quote],2)) > 0)
												echo "2017 - ".round($r_2017[frau_quote],2)."% (&uArr; ",round($r[frau_quote]-$r_2017[frau_quote],2),"%)<br>";
										?>
										</b></td></div>
									</tr>
									<tr height="30">
										<td>weitere/andere Gewichtungsjahre:</td>
										<td colspan=2>
											<b><? echo "<a href=\"bev_gw_2017.php?bev_gw_2017=",$r[gem_schl],"\">2017</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2016.php?bev_gw_2016=",$r[gem_schl],"\">2016</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2015.php?bevgw_2015=",$r[gem_schl],"\">2015</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2014.php?bevgw_2014=",$r[gem_schl],"\">2014</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2013.php?bevgw_2013=",$r[gem_schl],"\">2013</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2012.php?bevgw_2012=",$r[gem_schl],"\">2012</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2011.php?bevgw_2011=",$r[gem_schl],"\">2011</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2010.php?bevgw_2010=",$r[gem_schl],"\">2010</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_2009.php?bevgw_2009=",$r[gem_schl],"\">2009</a>, ";?></b>
											<b><? echo "<a href=\"bev_gw_1990.php?bevgw_1990=",$r[gem_schl],"\">1990</a>";?></b>
										</td>							
									</tr>
									<tr height="30">
