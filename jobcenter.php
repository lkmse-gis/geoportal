...
//globale Varibalen
$layername_mapfile="Jobcenter";
$titel="Jobcenter";
$titel_legende="Jobcenter";
$scriptname="jobcenter.php";
$tabelle="geoportal_jobcenter";
$schema="geoportal";
$get_themenname="jobcenter";
$layerid="150205";
$leg_bild="jobcenter2.gif";
...
if ($themen_id > 0)
   {   
	  ...
	  $query="SELECT astext(wkb_geometry) as utm, astext(st_transform(wkb_geometry,2398)) as gk4283,astext(st_transform(wkb_geometry, 4326)) as geo,astext(st_transform(wkb_geometry, 31468)) as rd83, gid, geoportal_anschrift, bezeichnung, tel, fax, mail, homepage, art, bild, oeffentlich FROM $schema.$tabelle WHERE gid='$themen_id'";
